...
import com.example.byg.exam_0120.services.MyIntentService;
import com.example.byg.exam_0120.services.MyService;
...
public class ServiceActivity extends AppCompatActivity {
    ...
    public void onStartService(View view) {
        // 1. Main 스레드에서 돈다. 그래서 Thread 를 별도 생성해서 실행해야 한다
        // 2. 병렬 실행 가능
